// Description: Simple per pixel lighting in ShaderLab and HLSL
// Implements Lambertian lighting
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings IN) : SV_Target
            {
                ...
                // Vertex normals can become unnormalised when they are interpolated 
                // so we should renormalise just to be sure

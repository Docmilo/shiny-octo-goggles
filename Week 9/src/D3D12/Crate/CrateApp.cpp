...
void CrateApp::BuildDescriptorHeaps()
{
	...
	srvHeapDesc.NumDescriptors = 2; //*changed from 1 to 2 for the second brick
...
void CrateApp::BuildMaterials()
{
	...
	//woodCrate->DiffuseAlbedo = XMFLOAT4(0.70f, 0.70f, 1.0f, 1.0f);
	brickMat->FresnelR0 = XMFLOAT3(0.05f, 0.05f, 0.05f);
...
void CrateApp::BuildRenderItems()
{
	...
	brickRitem->ObjCBIndex = 1; //***
	brickRitem->Mat = mMaterials["brickMat"].get();
	brickRitem->Geo = mGeometries["boxGeo"].get();
	brickRitem->PrimitiveType = D3D11_PRIMITIVE_TOPOLOGY_TRIANGLELIST;
